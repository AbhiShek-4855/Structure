...
class BaseApiHelper {
  ...
  static Future<ResponseItem> uploadMultipartImageRequest(
    String endPoint,
    dynamic requestData,
    bool passAuthToken,
  ) async {
  ...
  static Future<ResponseItem> multipartPutRequest(
    String requestUrl,
    dynamic requestData,
    bool passAuthToken,
  ) async {
  ...
  static Future<ResponseItem> getRequestWithQry(
      String requestUrl, Map<String, dynamic> queryParameters,
      [bool passAuthToken = false, CancelToken? cancelToken]) async {
    Dio dio = Dio();
